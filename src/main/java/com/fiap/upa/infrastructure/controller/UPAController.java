...
public class UPAController {
    ...
    public UPAController(CreateUPAUseCase createUPAUseCase, ListUPAsUseCase listUPAsUseCase, FindUPAUseCase findUPAUseCase, ListUPAReceptionsUseCase listUPAReceptionsUseCase, AddDoctorsUpaUseCase addDoctorsUpaUseCase, AddAttendantUpaUseCase addAttendantUpaUseCase, DeleteUPAUseCase deleteUPAUseCase, CreateReceptionUseCase createReceptionUseCase, StartReceptionUseCase startReceptionUseCase, FindReceptionUseCase findReceptionUseCase, EndReceptionUseCase endReceptionUseCase) {
